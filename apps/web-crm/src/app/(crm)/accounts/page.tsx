            ...
            {isLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="apple-table">
                  ...
                  <tbody>
                    {accounts.map((a) => (
                      <tr key={a.id} className="transition-colors duration-150 hover:bg-[#f5f5f7]">
                        <td>
                          <span className="inline-flex items-center rounded-md bg-[#f0f0ff] px-2 py-0.5 font-mono text-[12px] font-semibold text-[#4f46e5]">
                            {(a as Account & { customerCode?: string }).customerCode || '-'}
                          </span>
                        </td>
                        <td>
                          <a
