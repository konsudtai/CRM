...
echo ""
echo "  3. Create 3 Agents:"
echo "     a) Admin AI Agent (LINE OA auto-reply)"
echo "     b) น้องขายไว (Sales Personal Assistant)"
echo "     c) น้องวิ Analytics (Dashboard analytics)"
echo "     - IAM Role: $AGENT_ROLE"
echo "     - Model: Claude 3 Haiku (recommended)"
echo "     - Attach Knowledge Base from step 2"
echo "     - Copy each Agent ID"
echo ""
echo "  4. Enter IDs in CRM:"
